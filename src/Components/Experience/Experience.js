              ...
              <ul>
                ...
                <li>
                  <ul>
                    ...
                    <li>Python Scripts to convert file formats into compatiable formats</li>
                    <li>Node JS application using Electron for desktop application</li>
                  </ul>
                </li>
              </ul>
            </li>
        ...
        <div className="col-md-6">
          ...
          <ul>
            <li>
              ...
              become a professional web developer.</li>
              </ul>
            </li>
            <br />
            <li>
